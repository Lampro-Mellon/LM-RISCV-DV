...
SWERV_REMOTE='git@github.com:chipsalliance/Cores-SweRV-EL2.git'
SWERV_COMMIT_SHA='9260b5567cbf28dfe4b2153bbea1a8bd2d742228'
...
SWERV_LOCAL="${CORES}/Cores-SweRV-EL2"
...
printf "Checking for SweRV EL2 with COMMIT ID: ${RC_COMMIT_SHA} ...\n\n"
...
printf "Setting up the Environment for SweRV EL2 core in integrated_cores/SweRV_EL2 ...\n";

rm -rf "${INTEGRATED_CORES}/SweRV_EL2/"
cp -r "${INTEGRATION_FILES}/SweRV_EL2" "${INTEGRATED_CORES}/SweRV_EL2";
rm -rf "${INTEGRATED_CORES}/SweRV_EL2/google_riscv_dv/"
cp -r "${INTEGRATION_FILES}/SweRV_EL2/testbench" "${INTEGRATED_CORES}/SweRV_EL2/";
cp -r "${CORES}/Cores-SweRV-EL2/design" "${INTEGRATED_CORES}/SweRV_EL2/design/";
cp -r "${INTEGRATION_FILES}/SweRV_EL2/riscv_dv_extension" "${INTEGRATED_CORES}/SweRV_EL2/riscv_dv_extension/";
...
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/lm_run.py" "${RV_DV}/";
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/lm_cov.py" "${RV_DV}/";
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/src/riscv_instr_gen_config.sv" "${RV_DV}/src/";
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/src/riscv_asm_program_gen.sv" "${RV_DV}/src/";
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/scripts/gen_csr_test.py" "${RV_DV}/scripts/";
#cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/scripts/spike_log_to_trace_csv.py" "${RV_DV}/scripts/";
cp "${INTEGRATION_FILES}/SweRV_EL2/google_riscv_dv/scripts/instr_trace_compare.py" "${RV_DV}/scripts/";

# Setup SweRV-EH1 with riscv-compliance files
cp -r "${RC_LOCAL}/riscv-test-suite" "${INTEGRATED_CORES}/SweRV_EL2/directed_tests/";
cp -r "${RC_LOCAL}/riscv-test-env" "${INTEGRATED_CORES}/SweRV_EL2/snapshots/default/";
cp "${RC_LOCAL}/riscv-test-env/arch_test.h" "${INTEGRATED_CORES}/SweRV_EL2/snapshots/default/";
cp "${RC_LOCAL}/riscv-test-env/encoding.h" "${INTEGRATED_CORES}/SweRV_EL2/snapshots/default/";
#cp -r "${INTEGRATION_FILES}/SweRV_EL2/riscv-target/model_test.h" "${INTEGRATED_CORES}/SweRV_EL2/snapshots/default/";
